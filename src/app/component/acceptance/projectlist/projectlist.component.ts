...
import ProjectBusiness from '../../../business/acceptance.project.business';

@Component({
  selector: 'app-acceptanceprojectlist',
  templateUrl: './projectlist.component.html',
  styleUrls: ['./projectlist.component.css']
})
export class AcceptanceProjectlistComponent implements OnInit {
  ngOnInit(): void {
