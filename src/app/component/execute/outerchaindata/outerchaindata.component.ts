...
import OuterChainBusiness from '../../../business/execute.outerchain.business';
import {ActivatedRoute} from '@angular/router';

@Component({
  selector: 'app-executeouterchaindata',
  templateUrl: './outerchaindata.component.html',
  styleUrls: ['./outerchaindata.component.css']
})
export class ExecuteOuterchaindataComponent implements OnInit {
  ngOnInit(): void {
