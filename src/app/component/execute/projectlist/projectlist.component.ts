...
import ProjectBusiness from '../../../business/execute.project.business';

@Component({
  selector: 'app-executeprojectlist',
  templateUrl: './projectlist.component.html',
  styleUrls: ['./projectlist.component.css']
})
export class ExecuteProjectlistComponent implements OnInit {
  ngOnInit(): void {
