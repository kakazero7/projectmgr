...
import OuterChainBusiness from '../../../business/contract.outerchain.business';
import {ActivatedRoute} from '@angular/router';

@Component({
  selector: 'app-outerchaindata',
  templateUrl: './outerchaindata.component.html',
  styleUrls: ['./outerchaindata.component.css']
})
export class ContractOuterchaindataComponent implements OnInit {
  ngOnInit(): void {
